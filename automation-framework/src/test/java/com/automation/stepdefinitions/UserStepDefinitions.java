...
public class UserStepDefinitions {
    ...
    public void i_enter_user_name(String name) {
        ...
        userManagementPage.enterUserName(currentUserName);
    }
    ...
    public void i_enter_user_email(String email) {
        ...
        userManagementPage.enterUserEmail(currentUserEmail);
    }
    ...
    public void i_enter_user_password(String password) {
        ...
        userManagementPage.enterUserPassword(password);
    }
    ...
    public void i_select_university(String universityName) {
        ...
        userManagementPage.selectUniversity(universityName);
    }
    ...
    public void i_enter_graduation_year(String year) {
        ...
        userManagementPage.enterGraduationYear(year);
    }
    ...
    public void i_enter_major(String major) {
        ...
        userManagementPage.enterMajor(major);
    }
    ...
    public void i_toggle_mentor_status_on() {
        ...
        userManagementPage.toggleMentorOn();
    }
    ...
    public void i_should_see_user_in_the_users_list(String userName) {
        ...
        boolean userExists = userManagementPage.isUserInList(nameToCheck);
    ...
    public void i_should_not_see_user_in_the_users_list(String userName) {
        ...
        boolean userNotExists = userManagementPage.isUserNotInList(nameToCheck);
    ...
    public void i_click_on_toggle_status_button_for_user(String userName) {
        ...
        userManagementPage.clickToggleStatusButtonForUser(nameToToggle);
    }
    ...
    public void i_click_on_delete_button_for_user(String userName) {
        ...
        userManagementPage.clickDeleteButtonForUser(nameToDelete);
    }
    ...
    public void i_click_on_filter_button(String filterName) {
        ...
        userManagementPage.clickFilterButton(filterName);
    }
    ...
    public void i_should_see_only_users_with_role(String role) {
        ...
        boolean correctRoles = userManagementPage.areOnlyUsersWithRoleDisplayed(role);
    ...
    public void i_should_see_users_of_all_roles() {
        ...
        boolean allRoles = userManagementPage.areUsersOfAllRolesDisplayed();
